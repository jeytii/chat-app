...
import { Root as Slot } from 'radix-ui/slot'
import { type ComponentProps, createContext, type CSSProperties, useCallback, useContext, useEffect, useMemo, useState } from 'react'
...
function SidebarTrigger({ className, onClick, ...props }: ComponentProps<typeof Button>) {
    ...
    return (
        <Button
            ...
            {...props}
        >
            {isMobile || state === 'collapsed' ? <PanelLeftOpenIcon size={16} /> : <PanelLeftCloseIcon size={16} />}
